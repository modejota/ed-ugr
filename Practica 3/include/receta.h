...
/**
  ...
  *
  * { rep.code, rep.plato, rep.nombre, rep.ings, rep.calorias, rep.hc, rep.grasas, rep.proteinas, rep.fibra }
  *
  */
...
/**
  ...
  */
		friend ostream & operator << (ostream &os, receta &R);
...
/**
  * @section Iterador no constante de la clase Receta.
...
/**
  * @section Iterador constante de la clase Receta.
  * Nos permite desplazarnos comodamente a traves de la lista de ingredientes y cantidades que tenemos en el TDA Receta
  */
