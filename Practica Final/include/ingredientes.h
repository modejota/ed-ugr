...
/**
  * @section Iterator Iterador no constante de la clase Ingredientes.
  * Nos permite desplazarnos facilmente a traves de la lista de ingredientes.
  */

/**
  * @brief Iterador no constante de Ingredientes.
  */ 
	class iterator {
		private:
...
/**
  * @section Const_iterator Iterador constante de la clase Ingredientes.
  * Nos permite desplazarnos facilmente a traves de la lista de ingredientes, sin posibilidad de modificarla.
  */	

/**
  * @brief Iterador constante de Ingredientes.
  */ 
