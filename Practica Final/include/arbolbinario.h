...
using namespace std;
/**
  @page TDA Arbol Binario 
  @section defArbolBinario Definicion del TDA Arbol Binario
  Definición : Una instancia \a a del tipo de dato abstracto ArbolBinario sobre un
  dominio T se puede construir como:
   ...
   @section invArbolBinario   Invariante de la representacion
  
  Si r.raiz != 0,
  - r.raiz->padre == 0.
  - Para todo nodo n en el arbol con raiz r.raiz n->hizq<>n->hder y para todo par de nodos n y m en el arbol con raiz r.raiz si n->hizq=m o n->hder=m 
    entonces m->padre=n
  
   @section funArbolBinario Funcion de abstraccion

  Dado el objeto del tipo rep r, r = {raiz}, el objeto abstracto al que representa es:    
  ...
  c) Arbol con hijos a la izquierda y/o hijos a la derecha.
	r.raiz->hizq != 0 y/o r.raiz->hder != 0.


*/

/**
  * @brief TDA ArbolBinario
  */ 
template <class T>
class ArbolBinario{
	/**
	  * @brief Struct info_nodo.
	  */ 
	  private:
	  struct info_nodo{
		    T et;					/**< Etiqueta del nodo */
		    info_nodo * padre;		/**< Puntero al info_nodo padre */
		    info_nodo * hizq;		/**< Puntero al info_nodo hijo izquierda */
		    info_nodo * hder;		/**< Puntero al info_nodo hijo derecha */
		    /**
			  * @brief Constructor sin parametros de info_nodo
			  */  
			info_nodo(){ padre=hizq=hder=0; }

			/**
			  * @brief Constructor con parametros de info_nodo
	  ...
	  info_nodo * raiz;	/**< Puntero al info_nodo raiz */
 	  public:
		    ...
		    /**
		      * @brief Poda el hijo izquierda del nodo dado
		      * @param pos posicion del nodo
		   ...
		   /**
		    ...
		    class nodo{
			      private:
			         info_nodo *p;	/**< Puntero a info_nodo */
				  /**
		    ...
		    /******************************************************/
			/**
			  * @brief preorden_iterator de ArbolBinario
			  */ 
		    class preorden_iterador{
				...
				/**
				  * @brief Operador ++ de preorden_iterator 
				  */ 
		    ...
		    /******************************************************/
			/**
			  * @brief inorden_iterator de ArbolBinario
			  */ 
		    class inorden_iterador{
				...
				/**
				  * @brief Operador ++ de inorden_iterator
				  */  
		    ...
		    /*******************************************************/
			/**
			  * @brief postorden_iterator del ArbolBinario
			  */ 
		    class postorden_iterador{
			      private:
			         info_nodo *p;	/**< Puntero a info_nodo */
				...
				/**
				  * @brief Operador ++ de postorden_iterator
				  */
		    ...
		    /***FUNCIONES BEGIN y END PARA PREORDEN_ITERATOR***/
		    /**
		    ...
		    */
		    ...
		    /***FUNCIONES BEGIN y END PARA INORDEN_ITERATOR***/
		    /**
		    ...
		    /***FUNCIONES BEGIN y END PARA POSTORDEN_ITERATOR***/
		    /**
